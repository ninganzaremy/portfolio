/*sidebar*/
var menuBtn = document.getElementsByClassName("navtoggler");
var mobileMenu = document.getElementsByClassName("offcanvas-menu");
...
window.onscroll = () => {
	...
	if (this.scrollY <= 20) nav.className = "";
	else nav.className = "header-area-wrapper";
};
